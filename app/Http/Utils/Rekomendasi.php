...
{
    const TIDAK_NORMAL = '<p style="text-align: justify;">Maka perlu dikonfirmasi oleh petugas kesehatan yang berkompeten untuk dilakukan: penilaian status gizi berdasarkan indeks BB/U, PB/U atau TB/U, BB/PB dan atau BB/TB, IMT/U</strong></p> Tekan selanjutnya untuk melakukan penilaian perkembangan balita';
    ...
    const TIDAK_NORMAL_JAWABAN = '<p style="text-align: justify;">Maka perlu dikonfirmasi oleh petugas kesehatan yang berkompeten untuk dilakukan: penilaian status gizi berdasarkan indeks BB/U, PB/U atau TB/U, BB/PB dan atau BB/TB, IMT/U</strong></p> Tekan selanjutnya untuk melakukan penilaian perkembangan balita';
