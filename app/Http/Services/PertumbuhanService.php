...
class PertumbuhanService  
{
    ...
    public function getHasilPertumbuhan()
    {
        ...
        $this->pertumbuhan->status_pertumbuhan = 'Berat balita '.$this->berat_badan.' Kg dengan ambang batas '.$hasil_pertumbuhan->get('hasil'). '</p> , <p> Tekan selanjutnya untuk melihat rekomendasi pertumbuhan balita</p>';
        return $this;
    }
